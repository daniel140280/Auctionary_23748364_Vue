    ...
    <div class="auth-page-wrapper">
      <div class="auth-container">
        ...
        <form @submit.prevent="handleSubmit" class="auth-form">
          <div class="form-row">
            <div class="form-group">
              ...
              <input
                ...
                required
              />
              <div class="error-text" v-show="submitted && !first_name">First name is required</div>
            </div>
            ...
            <div class="form-group">
              ...
              <input
                ...
                required
              />
              <div class="error-text" v-show="submitted && !last_name">Last name is required</div>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <input
              ...
              id="email"
              v-model="email"
              placeholder="boaty.mcboatface@example.com"
              autocomplete="email"
              required
            />
            <div class="error-text" v-show="submitted && !email">Email is required</div>
          </div>
        ...
        <div class="auth-footer">
          <p>Already have an account?<router-link to="/login" class="link-primary">Login here</router-link>
          </p>
        </div>
      </div>
    </div>
